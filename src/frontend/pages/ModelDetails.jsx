...
function ModelDetails() {
  ...
  const vehicles = useSelector((state) => state.tabtypeCar.vehicles);
  const colorsData = useSelector((state) => state.vehicleColor.colorsData);
  ...
  return (
    <div>
      ...
      {data.length > 0 && <Warranty warranty={data[0]?.urlWarrantyImg} />}
    </div>
  );
}
