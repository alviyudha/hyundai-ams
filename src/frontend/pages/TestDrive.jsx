    ...
    <div className="max-w-xl mx-auto p-5 shadow-lg shadow-hyundai rounded-lg">
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select id="dealer" name="dealer" className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-hyundai focus:border-hyundai rounded-md" required onChange={(e) => setSelectedDealer(parseInt(e.target.value))}>
            {dealers.map(dealer => (
