...
function VehiclesColorsComp() {
  ...
  const [setCurrentBackgroundColor] = useState("");
  ...
  return (
    <div className="mx-auto my-10 max-w-screen-lg">
      <div className="text-center mt-5">
        <h3 className="font-bold text-4xl mb-2 text-shadow">
      ...
      <div className="mt-5 rounded-lg overflow-hidden shadow-xl">
        <div className="rounded bg-gradient-to-r from-gray-200 via-white to-gray-200 text-center drop-shadow-2xl">
          <img
            src={currentImage}
            alt="Car"
            className="mx-auto hover:scale-105 transition-all duration-500"
            ...
            <table className="min-w-full bg-white border border-gray-200">
              <tbody>
                <tr className="border-b">
                  ...
                  <td className="capitalize font-bold p-4 bg-gray-50">
                    {currentDescColor}
                  </td>
                </tr>
                <tr className="border-b">
                  ...
                  <td className="capitalize font-bold p-4 bg-gray-50">
                    {colorsData[0]?.trim || "N/A"}
                  </td>
                </tr>
                <tr className="border-b">
                  <td className="font-bold p-4 bg-gray-100">Price</td>
                  <td className="capitalize font-bold p-4 bg-gray-50">
                    Rp. {colorsData[0]?.otrPrice?.toLocaleString() || "N/A"}
                  </td>
                </tr>
                <tr>
