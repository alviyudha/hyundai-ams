...
function PromoLeasing({ dealers }) {
  ...
  const handleSubmit = async (event) => {
    ...
    const data = {
      ...
      dp: formData.get("dp"),
      whatsapp: dealers.find((dealer) => dealer.name === selectedDealer)
        .whatsapp,
    };
    ...
    <div id="promoLeasing" className="">
      <div className="container mx-auto p-10 shadow bg-[#00ADD7]">
        <h5 className="text-2xl font-bold mb-5 text-white">
          Nikmati promo menarik dari bank partner kami
        </h5>
        <div className="flex flex-wrap justify-center md:justify-start space-x-2 md:space-x-4 mb-4 md:mb-5">
          <img
            src="/img/logo-leasing/hmf.png"
            alt="Bank CIMB"
            className="me-2 mb-2 h-5/6"
          />
          <img
            src="/img/logo-leasing/mtf.png"
            alt="Bank My Bank"
            className="me-2 mb-2 h-5/6"
          />
          <img
            src="/img/logo-leasing/shinhan.png"
            alt="Leasing Hasjrat Multiginance"
            className="me-2 mb-2 h-5/6"
          />
          <img
            src="/img/logo-leasing/mybank.png"
            alt="Leasing Mega finance"
            className="me-2 mb-2 h-5/6"
          />
        </div>
