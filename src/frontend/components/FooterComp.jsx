...
export default function FooterComp() {
  return (
    <div>
      <footer
        className="footer text-white p-10 bg-hyundai"
        data-aos="fade-up"
      ...
      >
        <div className="container mx-auto grid grid-cols-1">
          <div>
            ...
            <p>
              ...
              <br />
              <strong>Phone:</strong> 0812-9000-8526
              <br />
              <strong>Email:</strong> info@hyundaiams.co.id
              <br />
            </p>
          </div>
        </div>
        <nav>
          ...
          <a className="link link-hover">
            Hyundai City Store Summarecon Mall Serpong
          </a>
        </nav>
      </footer>
