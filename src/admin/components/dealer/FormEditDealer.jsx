  ...
  return (
    ...
    <div className="w-full max-w-md bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="urlFacebook">
                    Facebook URL
                </label>
                <input
                    type="url"
            ...
            <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="urlMaps">
                    Maps URL
                </label>
                <input
                    type="url"
            ...
            <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="urlInstagram">
                    Instagram URL
                </label>
                <input
                    type="url"
            ...
            <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="imgDealer">
                    Dealer Image
                </label>
                <input
                    type="file"
                ...
                {urlImageDealer && (
                    <div className="mt-2">
                        ...
                        <img src={urlImageDealer} alt="Dealer" className="mt-2 rounded-md shadow-md max-w-xs" />
                    </div>
                )}
            </div>
