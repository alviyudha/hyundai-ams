    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded shadow-md w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          <div className="mb-4">
            <label className="block text-gray-700 mb-2" htmlFor="urlFacebook">
              Facebook URL
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 mb-2" htmlFor="urlMaps">
              Google Maps URL
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 mb-2" htmlFor="urlInstagram">
              Instagram URL
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 mb-2" htmlFor="imgDealer">
              Dealer Image
            </label>
            <input
              type="file"
