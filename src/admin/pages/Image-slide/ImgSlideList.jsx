            ...
            {imgslide.map((imgslides) => (
              <tr key={imgslides.id}>
                <td className="py-2 border-b text-center">
                  <img src={imgslides.urlImage} alt={imgslides.image} className="w-auto h-16 object-cover mx-auto" />
                </td>
                <td className="py-2 border-b text-center">
                  <Link to={`/admin-hyundai/image-slide/edit/${imgslides.id}`} className="text-blue-500 mr-4">Edit</Link>
                  <button
