            ...
            {colors.map((color) => (
              <tr key={color.id}>
                <td className="py-2 border-b text-center">
                  <img src={color.urlcolorsImage} alt={color.descColor} className="w-16 h-16 object-cover mx-auto" />
                </td>
                <td className="py-2 border-b text-center">{color.backgroundColor}</td>
                <td className="py-2 border-b text-center">{color.descColor}</td>
                <td className="py-2 border-b text-center">{color.model}</td>
                <td className="py-2 border-b text-center">
                  <Link to={`/admin-hyundai/colors/edit/${color.id}`} className="text-blue-500 mr-4">Edit</Link>
                  <button
